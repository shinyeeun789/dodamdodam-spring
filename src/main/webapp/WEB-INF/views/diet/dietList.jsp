...
<body class="is-preload">
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$("#dietMonth").change(function() {
				$.ajax({
					url		 : "/diet/getDietListWithMonth.do",
					method 	 : "GET",
					dataType : "JSON",
					data	 : {"userID":"${userVO.userID}", "dietMonth":$("#dietMonth").val()},
					...
					<form name="dietPlus_form" method="post">
						<div class="row gtr-uniform">
							<div class="col-12">
								...
								<input type="month" name="dietMonth" id="dietMonth">
							</div>
							<div class="col-12">
								<div id="grid"></div>
							</div>
